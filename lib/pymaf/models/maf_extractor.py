...
# https://github.com/shunsukesaito/PIFu/blob/master/lib/model/SurfaceClassifier.py
...
cfg = load_config(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../configs/pymaf_config.yaml"))
