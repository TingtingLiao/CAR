...
if __name__ == '__main__':
    ...
    # python -m apps.train -cfg configs/ours2.yaml -g 1 -d mvp
    ...
    # parser.add_argument('-d', '--data', type=str, default="th", help='dataset name')
    args = parser.parse_args()

    cfg = load_config(args.config, 'configs/default.yaml')
    cfg.dataset.merge_from_list(['num_views', args.num_views])
    ...
    # exit()
    if args.test:
        test_dataset = EvalDataset(cfg.training.data_name, cfg, trainer.device)
